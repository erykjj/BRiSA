...
- Export and Import buttons allow saving current progress to a simple text file and restoring it on a new or updated plan (e.g., when changing theme). Only matching day numbers are imported, so ensure the plans are compatible.
